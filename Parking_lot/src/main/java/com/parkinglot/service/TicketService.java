...
public class TicketService {
        ...
        if (vehicle == null) {
            ...
            boolean check= true;
                ...
                if(check) {
                    ...
                    Ticket ticket = new Ticket(assignedSlotNumber, vehicle,time);
    ...
    public double exitVehicle(int slotNumber) {
        if (ticketMap.containsKey(slotNumber)) {
            ...
            Ticket ticket= ticketMap.get(slotNumber);
            LocalTime parkingtime =ticket.parkingTime;
            LocalTime currentTime = LocalTime.now();
            LocalTime tempDateTime = parkingtime.from( currentTime );
    ...
    private class Ticket {
        ...
        Ticket(int slotNumber, Vehicle vehicle,LocalTime parkingTime) {
